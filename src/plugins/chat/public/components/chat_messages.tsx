...
import { StarterSuggestionItem, StarterSuggestionsResult } from '../services/starter_suggestions';
...
const ChatMessagesComponent: React.FC<ChatMessagesProps> = ({
  ...
  const { starterSuggestionsService, chatService } = useChatContext();
